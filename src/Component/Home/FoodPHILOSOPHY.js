...
import two from "../../../public/images/philosphy/uper.jpg";
import first from "../../../public/images/philosphy/down.jpg";

const FoodPHILOSOPHY = () => {
  return (
    <div className="container mx-auto">
      <div className=" md:mt-48 lg:mt-24">
          ...
          <div>
            <div className="md:ml-16 ml-10 lg:ml-0 md:mt-7 lg:mt-0">
              <div className="flex items-center ">
                <h6 className="text-xl text-deepIndigo font-bold">
                  QUALITY & BALANCE
                </h6>
                <hr className="w-20 h-1 ml-8 bg-deepIndigo" />
              </div>
              ...
              <button className="uppercase py-3 px-6 text-white bg-deepIndigo font-semibold">
                Learn more
              </button>
            </div>
          </div>
