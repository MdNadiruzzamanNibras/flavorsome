        ...
        <div className='container mx-auto'>
            ...
            <div className='grid lg:grid-cols-3 lg:gap-3 container'>
                <div className="card lg:w-96   py-3 px-4  shadow-xl">
                    ...
                    />
                    <div>
                        <h4 className='text-lg font-medium text-gray-400'>Sept. 06, 2019   Admin</h4>
                        <h2 className='text-2xl font-bold text-black'>Taste the delicious foods in Asia</h2>
                        <div className='flex justify-between items-center'>
                            <div><button>Read more..</button> </div>
                            <div className='flex  items-center'><TfiCommentAlt/> <p className='ml-1'> 3</p></div>
                        </div>
                    </div>
                </div>
