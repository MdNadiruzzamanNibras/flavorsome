...
const CateringServices = () => {
    return (
        <div className='my-16 container mx-auto'>
            <h1 className="lg:text-5xl lg:font-extrabold text-center">Catering Services</h1>
            <div className='lg:flex lg:justify-evenly lg:items-center my-8'>
                <div className='text-center'>
                    <Image
                        className='w-28 ml-28 lg:ml-20 mb-7'
                        src={cake}
                        alt="Birthday Party"
                    />
                ...
                <div className='text-center'>
                    <Image
                        className='w-32 ml-28 lg:ml-16 mb-2'
                        src={meeting}
                ...
                <div className='text-center'>
                    <Image
                        className='w-24 ml-36 lg:ml-20 mb-5 mt-5'
                        src={food}
                        alt="Wedding Party"
                    />
