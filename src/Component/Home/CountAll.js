...
const CountAll = () => {
  ...
  return (
    <div className="container mx-auto mb-12">
      ...
      <div className="absolute  mt-[-500px] lg:mt-[-200px]">
        <div
          className="grid  text-center
         text-white grid-cols-12   mb-4 "
        >
          <div className=" mt-5 col-span-12 text-center lg:px-14  md:col-span-6 lg:col-span-3 ">
          ...
          <div className="mt-5 col-span-12 lg:px-14 md:col-span-6 lg:col-span-3">
            <h1 className="text-6xl lg:text-8xl text-stone-300 font-bold">
